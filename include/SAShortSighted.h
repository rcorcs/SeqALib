...
class ShortSightedSA : public SequenceAligner<ContainerType,Ty,Blank,MatchFnTy> {
private:
...
public:
  ShortSightedSA(ScoringSystem Scoring, MatchFnTy Match = nullptr, size_t WindowSize = 128) : BaseType(Scoring, Match), WindowSize(WindowSize) {}
